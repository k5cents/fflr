...
#'
#' Take a team's draft list and return a single row tibble. This function
#' is used in [form_draft()] to combine the entries from an entire team into a
#' single tibble.
#'
#' @param pick The `pick` element of `draft` list from a `team` list.
