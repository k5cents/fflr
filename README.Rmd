...
The `fflr` package is used to query the [ESPN Fantasy Football API](https://fantasy.espn.com/apis/v3/games/ffl/), for both the current and past seasons. Collect statistics for fantasy teams and individual players.
