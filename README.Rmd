...
<!-- badges: start -->
[![Lifecycle: experimental](https://img.shields.io/badge/lifecycle-experimental-orange.svg)][life]
[![CRAN status](https://www.r-pkg.org/badges/version/fflr)][cran]
[![Travis build status](https://travis-ci.org/kiernann/fflr.svg?branch=master)][trav]

[life]: (https://www.tidyverse.org/lifecycle/#experimental)
[cran]: (https://CRAN.R-project.org/package=fflr)
[trav]: (https://travis-ci.org/kiernann/fflr)
<!-- badges: end -->
