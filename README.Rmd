...
You can install the released version of `fflr` from [CRAN][cran] with:

```{r install_cran, eval=FALSE}
install.packages("fflr")
```

The development version can be installed from [GitHub][fflr] with:
...
Most data can only be retrieved from _public_ leagues. [This ESPN help
...
Then data can be scraped and automatically formatted as rectangles and lists.
